...
<div class="container-fluid py-5">
    <div class="row px-xl-5">
            ...
            <div id="product-carousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner border">
                    <div class="carousel-item active">
                        <img class="w-100 h-100" src="/assets/img/{{$sanpham->image}}" alt="Image">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-7 pb-5">
            ...
            <h3 class="font-weight-semi-bold mb-4">{{number_format($sanpham->unit_price)}} ₫</h3>
            <p class="mb-4">{{$sanpham->mota_sp}}</p>
            <div class="d-flex mb-3">
                <p class="text-dark font-weight-medium mb-0 mr-3">Size: {{$sanpham->size}}</p>
            </div>
            <div class="d-flex align-items-center mb-4 pt-2">
                <form action="{{ route('cart.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="hidden" value="{{ $sanpham->unit_price }}" name="price">
