        ...
        <div class="col-lg-8 table-responsive mb-5">
            <table class="table table-bordered text-center mb-0">
                ...
                @foreach ($cartItems as $item)
                    <tr>
                        <td class="align-middle"><img src="/assets/img/{{ $item->attributes->image }}" alt="" style="width: 50px;"> {{ $item->name }}</td>
            ...
            <div>
                <form action="{{ route('cart.clear') }}" method="POST">
                    @csrf
                    <button class="btn btn-block btn-primary my-3 py-3">Remove All Cart</button>
                </form>
            </div>
        </div>
        <div class="col-lg-4">
            ...
            <div class="card border-secondary mb-5">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-3 pt-1">
                        ...
                        <h6 class="font-weight-medium">{{number_format(\Cart::getSubTotal())}} ₫</h6>
                    </div>
                ...
                <div class="card-footer border-secondary bg-transparent">
                    <div class="d-flex justify-content-between mt-2">
                        ...
                        <h5 class="font-weight-bold">{{number_format(\Cart::getTotal())}} ₫</h5>
                    </div>
                    <a href="{{route('cart.thanhtoan')}}" class="btn btn-block btn-primary my-3 py-3">Proceed To Checkout</a>
                </div>
            </div>
        </div>
    </div>
