                ...
                <div class="mb-4">
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <label>Name</label>
                            <input name="txtname" class="form-control" type="text" placeholder="John">
                        </div>
                        
                        <div class="col-md-6 form-group">
                            <label>E-mail</label>
                            <input name="txtemail" class="form-control" type="text" placeholder="example@email.com">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Mobile No</label>
                            <input name="txtphone" class="form-control" type="text" placeholder="+123 456 789">
                        </div>
                        <div class="col-md-6 form-group">
                            <label>Address</label>
                            <input name="txtaddress" class="form-control" type="text" placeholder="123 Street">
                        </div>
                    </div>
                </div>
            </div>
